...
FRONT_PAGE_ROUTES = [
    ...
    },
    {
        ...
        "reason": "puts the 27/81/243 result on the front page without pretending it is a packaged reproduction bundle",
    },
    {
...
COHESION_CHECKS = [
    {
        "check": "readme_front_page_not_ledger_dump",
        "pass_signal": "README carries top-card links and a compact holdout snapshot, not the full evidence ledger",
        "failure_signal": "README again becomes a wall of version notes and old evidence tables",
...
def _write_read(path: Path) -> None:
    ...
    lines.extend([
        ...
        "",
        "| earned | raw pressure | latent | relation debt | return debt | false pressure | final false crowns |",
        "|---:|---:|---:|---:|---:|---:|---:|",
        f"| {totals['earned']} | {totals['raw']} | {totals['latent']} | {totals['relation']} | {totals['return']} | {totals['false_pressure']} | {totals['false_crowns']} |",
        "",
        "## Route shift",
        "",

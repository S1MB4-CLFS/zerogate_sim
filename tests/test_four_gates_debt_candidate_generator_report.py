...
def test_generator_public_surfaces_and_route_are_current() -> None:
    ...
    assert "1.6.20-alpha" in (ROOT / "src/zerogate_sim/__init__.py").read_text(encoding="utf-8")
    assert 'version = "1.6.20a0"' in (ROOT / "pyproject.toml").read_text(encoding="utf-8")

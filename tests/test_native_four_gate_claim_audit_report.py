...
def test_public_version_truth_surfaces_preserve_v1_6_14_and_route_to_v1_6_15() -> None:
    ...
    assert "1.6.16-alpha" in (ROOT / "src/zerogate_sim/__init__.py").read_text(encoding="utf-8")
    assert 'version = "1.6.16a0"' in (ROOT / "pyproject.toml").read_text(encoding="utf-8")

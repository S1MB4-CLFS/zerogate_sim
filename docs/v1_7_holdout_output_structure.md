...
This note records the output structure required after the `v1.7.6-alpha` fresh holdout contract and before `v1.7.7-alpha` reviewer packaging.
...
`v1.7.7-alpha` should package reviewer/reproduction guidance only after the holdout run flow produces clean rung-level output. It should include this structure:

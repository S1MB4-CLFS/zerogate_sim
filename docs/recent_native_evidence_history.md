...
**Purpose:** move the long native route list out of the README while preserving traceability.

The README should show the project. This file can hold the ledger.

## Native route into v1.7
...
- `v1.6.17-alpha` — Deep81 / Wide243 Native Evidence with partial debt lanes.
...
Older proof and shadow history lives in the history vault. Native math remains:
